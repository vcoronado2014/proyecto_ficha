...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="row topRow">
        ...
        <dx:ASPxGridView ID="grillaRoles" runat="server" AutoGenerateColumns="False" DataSourceID="odsRoles" KeyFieldName="FipeId" Theme="Mulberry" Width="100%" PreviewFieldName="Detalle">
            ...
            <SettingsText ConfirmDelete="¿Está seguro de Eliminar esta Ficha de Personal?" CommandDelete="Borrar" />
            <Columns>
                ...
                <dx:GridViewDataTextColumn FieldName="NombreCompleto" VisibleIndex="2" Width="75%" Caption="Nombres">
                ...
                <dx:GridViewDataTextColumn Caption="Rut" FieldName="Rut" VisibleIndex="3" Width="10%" Visible="False">
